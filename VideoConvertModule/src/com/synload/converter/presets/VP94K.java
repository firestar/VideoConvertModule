...
public class VP94K extends Preset {
	public VP94K(FFmpegProbeResult video, String source, String output, String extra){
		super(commandify(video, source, output, extra, "%FFMPEG% -i %TEMP%%EXTRA% -threads 8 -r %FPS% -vcodec vp9 -acodec libvorbis -ac 2 -maxrate 23000k -b:v 20000k -b:a 196k -ar 44100 -s 3840x2160 %FINAL%.webm"));
	}
}
